...
fun rememberNavigationState(
    ...
    val subStacks = topLevelRoutes.associateWith { key -> rememberNavBackStack(key) }
...
class NavigationState(
    ...
    val currentSubStack: NavBackStack<NavKey>
        get() = subStacks[currentTopLevelRoute]
            ?: error("Sub stack for $currentTopLevelRoute does not exist")
